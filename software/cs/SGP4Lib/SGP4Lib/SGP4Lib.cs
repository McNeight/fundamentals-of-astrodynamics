...
namespace SGP4Methods
{
    public class SGP4Lib
    {
        ...
        public class elsetrec
        {
            ...
            public string active; // "Active S/C" flag (0=n, 1=y) 
            public string not_orbital; // "Orbiting S/C" flag (0=n, 1=y)  
            public double rcs_m2; // "RCS (m^2)" storage  

        }  // elsetrec class

        public enum gravconsttype { wgs72old, wgs72, wgs84 }; // wgs72 is the standard and should be used with JSPOC TLEs

        // use a struct for all the elsetrec so it can be processed
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        private void dpper
             (
               ...
               char init,
               ref double ep, ref double inclp, ref double nodep, ref double argpp, ref double mp,
               char opsmode
             )
        {
            /* --------------------- local variables ------------------------ */
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        private void dscom
             (
               ...
               out double snodm, out double cnodm, out double sinim, out double cosim, out double sinomm,
               out double cosomm, out double day, out double e3, out double ee2, out double em,
               out double emsq, out double gam, out double peo, out double pgho, out double pho,
               out double pinco, out double plo, out double rtemsq, out double se2, out double se3,
               out double sgh2, out double sgh3, out double sgh4, out double sh2, out double sh3,
               out double si2, out double si3, out double sl2, out double sl3, out double sl4,
               out double s1, out double s2, out double s3, out double s4, out double s5,
               out double s6, out double s7, out double ss1, out double ss2, out double ss3,
               out double ss4, out double ss5, out double ss6, out double ss7, out double sz1,
               out double sz2, out double sz3, out double sz11, out double sz12, out double sz13,
               out double sz21, out double sz22, out double sz23, out double sz31, out double sz32,
               out double sz33, out double xgh2, out double xgh3, out double xgh4, out double xh2,
               out double xh3, out double xi2, out double xi3, out double xl2, out double xl3,
               out double xl4, out double nm, out double z1, out double z2, out double z3,
               out double z11, out double z12, out double z13, out double z21, out double z22,
               out double z23, out double z31, out double z32, out double z33, out double zmol,
               out double zmos
             )
        {
            /* -------------------------- constants ------------------------- */
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        private void dsinit
            ...
            // gravconsttype whichconst, 
               ...
               double eccsq, ref double em, ref double argpm, ref double inclm, ref double mm,
               ref double nm, ref double nodem,
               out int irez,
               ref double atime, ref double d2201, ref double d2211, ref double d3210, ref double d3222,
               ref double d4410, ref double d4422, ref double d5220, ref double d5232, ref double d5421,
               ref double d5433, out double dedt, out double didt, out double dmdt, out double dndt,
               out double dnodt, out double domdt, ref double del1, ref double del2, ref double del3,
               ref double xfact, ref double xlamo, ref double xli, ref double xni
             )
        {
            /* --------------------- local variables ------------------------ */
            const double twopi = 2.0 * Math.PI;
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        private void dspace
             (
               ...
               double no,
               ref double atime, ref double em, ref double argpm, ref double inclm, ref double xli,
               ref double mm, ref double xni, ref double nodem, out double dndt, ref double nm
             )
        {
            const double twopi = 2.0 * Math.PI;
            int iretn;  //, iret;
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        private void initl
            ...
            // gravconsttype whichconst, 
               ...
               double ecco, double epoch, double inclo, ref double no_kozai,
               out char method,
               out double ainv, out double ao, out double con41, out double con42, out double cosio,
               out double cosio2, out double eccsq, out double omeosq, out double posq,
               out double rp, out double rteosq, out double sinio, out double gsto,
               char opsmode, out double no_unkozai
             )
        {
            /* --------------------- local variables ------------------------ */
            ...
            ao = Math.Pow(xke / (no_unkozai), x2o3);
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        public void sgp4init
             (
               ...
               double xnodeo, ref elsetrec satrec
             )
        {
            /* --------------------- local variables ------------------------ */
            ...
            initl
                (satrec.xke, satrec.j2, satrec.ecco, epoch, satrec.inclo, ref satrec.no_kozai, out satrec.method,
                  out ainv, out ao, out satrec.con41, out con42, out cosio, out cosio2, out eccsq, out omeosq,
                  out posq, out rp, out rteosq, out sinio, out satrec.gsto, satrec.operationmode, out satrec.no_unkozai);
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        public void getgravconst
             (
              gravconsttype whichconst,
              out double tumin,
              out double mu,
              out double radiusearthkm,
              out double xke,
              out double j2,
              out double j3,
              out double j4,
        ...
        // ---------------------------------------------------------------------------------
        // routines to input data to SGP4
        //
        //class sgp4io
        //{
        //
        ...
        *    vallado, crawford, hujsak, kelso  2006
        ...
        public void twoline2rv
             (
              string longstr1, string longstr2,
              char typerun, char typeinput, char opsmode,
              gravconsttype whichconst,
              out double startmfe, out double stopmfe, out double deltamin,
              out elsetrec satrec
             )
        {
            ...
            satrec.epochdays = Convert.ToDouble(linedata[6]);
            satrec.ndot = Convert.ToDouble(linedata[7])* 0.00001;
            satrec.nddot = Convert.ToDouble(linedata[8]);
            try
            {
                nexp = Convert.ToInt16(linedata[9]);
            }
            catch
            {
                nexp = 0;
            }
            satrec.bstar = Convert.ToDouble(linedata[10]);
            try
            {
                ibexp = Convert.ToInt16(linedata[11]);
            }
            catch
            {
                ibexp = 0;
        ...
        *
        *  outputs       :
        *    outvec      - vector result of a x b NOTE: do not need "out" with it
        *
        *  locals        :
        *    none.
        *
        ...
        *    mag           magnitude of a vector
        ...
        public void cross
                (
                  double[] vec1, double[] vec2, double[] outvec
                )
        {
        ...
        * --------------------------------------------------------------------------- */
        ...
        public void rv2coe
             (
               ...
               out double p, out double a, out double ecc, out double incl, out double omega, out double argp,
        ...
        *  inputs          description                    range / units
        *    jd          - julian date (days only)           days from 4713 bc
        *    jdFrac      - julian date (fraction of a day)   days from 4713 bc
        *
        *  outputs       :
        *    year        - year                           1900 .. 2100
        *    mon         - month                          1 .. 12
    ...
    // enable an input from the screen during runtime
    public class InputBox
    {
        public static DialogResult Show(string title, string promptText, ref string value1, ref string value2)
        {
            Form iform = new Form();
            ...
            textBox2.SetBounds(200, 36, 160, 20);
            ...
            iform.ClientSize = new Size(396, 107);
            iform.Controls.AddRange(new Control[] { label, textBox1, buttonOk, buttonCancel });
            iform.Controls.AddRange(new Control[] { label, textBox2, buttonOk, buttonCancel });
            iform.ClientSize = new Size(Math.Max(300, label.Right + 10), iform.ClientSize.Height);
            iform.FormBorderStyle = FormBorderStyle.FixedDialog;
            iform.StartPosition = FormStartPosition.CenterScreen;
            iform.MinimizeBox = false;
            iform.MaximizeBox = false;
            iform.AcceptButton = buttonOk;
            iform.CancelButton = buttonCancel;

            DialogResult dialogResult = iform.ShowDialog();
